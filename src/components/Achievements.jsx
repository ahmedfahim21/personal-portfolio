...
const Achievements = () => {
  ...
  return (
    <section
      className="bg-slate-200 overflow-hidden text-primary py-10 md:mt-10 relative"
      id="achievements"
    >
          ...
          <div className="my-20">
            ...
            <div className="flex justify-end mb-4">
              <button
                ...
                className="p-2 bg-secondary rounded-full disabled:opacity-50 mx-2"
              >
                &lt;
              </button>
              <button
...
const AchievementCard = (props) => {
  return (
    <div className="achievement-card flex-shrink-0 flex flex-col md:w-[400px] w-[320px] justify-around px-6 py-4 rounded-[20px] md:mr-10 mr-6 my-5 transition-colors duration-300 transform border border-primary">
      <img
        src={props.icon}
        alt={props.event}
      ...
      <div className="flex flex-col justify-end mt-4 mb-1">
        <p className="font-poppins font-normal text-xl text-primary leading-[24px] mb-2">
          {props.event}
        </p>
        ...
        {props.content1 && (
          <p className="font-poppins font-normal text-gray-600 text-sm mb-1">
            🚀 {props.content1}
          </p>
        )}
        {props.content2 && (
        ...
        {props.content3 && (
          <p className="font-poppins font-normal text-gray-600 text-sm mb-4">
            🔥 {props.content3}
          </p>
        )}
      </div>
      <div className="flex flex-row mb-2 font-poppins font-normal text-gray-600">
        {props.article && (
          <a
            className="inline-flex items-center mr-2 hover:text-secondary"
            href={props.article}
            target="_blank"

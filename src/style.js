const styles = {
  ...
  heading2:
    "font-poppins font-semibold xs:text-[48px] text-[40px] text-[#1a1a1a] xs:leading-[76.8px] leading-[66.8px] w-full",
  paragraph:
    "font-poppins font-normal text-[#4a5568] text-[18px] leading-[30.8px]",
